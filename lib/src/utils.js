...
exports.safeGet = exports.uniqueByKey = exports.resolveObjectPath = exports.applyValue = exports.getPathElements = exports.checkPath = void 0;
...
var safeGet = function (obj, key, fallback) { return (key in obj ? obj[key] : fallback); };
